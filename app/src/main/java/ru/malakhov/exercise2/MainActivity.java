...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.btnSend:
                sendEmail(new String[] {"baunty3000@gmail.com"}, "Привет! Я из приложения !", mPtMessage.getText().toString());
                break;
            case R.id.ibTelIcon:
    ...
    private void sendEmail(String[] to, String subject, String body){
        ...
        if (sendEmailIntent.resolveActivity(getPackageManager()) != null) {
            ...
            Toast.makeText(this, "Для отправки почты нужен почтовый клиент", Toast.LENGTH_SHORT).show();
        }
    }
}
